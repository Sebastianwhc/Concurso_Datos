...
/*
 * Simulator Mockup Section — Glassmorphism UI showcase
 * Shows a predictive simulator interface with climate sliders.
 */
    ...
    >
      ...
      <div
        style={{
          ...
          width: '30vw',
          height: '30vw',
          background: 'radial-gradient(ellipse, rgba(179,0,255,0.03) 0%, transparent 70%)',
          pointerEvents: 'none',
        }}
      />
      ...
      <div style={{ maxWidth: '1100px', width: '100%', position: 'relative', zIndex: 1 }}>
        ...
        {/* Glassmorphism Simulator Mockup */}
        <div
          ref={mockupRef}
          style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontSize: '0.95rem', fontWeight: 700, color: '#fff' }}>
                  Motor Predictivo v2.0
                </div>
                <div style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.4)' }}>
                  LSTM + Variables Climáticas
                </div>
              </div>
            </div>
            <div
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.8rem' }}>
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  borderRadius: '3px',
                  appearance: 'none',
                  background: `linear-gradient(90deg, #0066aa 0%, #00b8ff 50%, #00f0ff 100%)`,
                  outline: 'none',
                  cursor: 'pointer',
                }}
              />
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '14px',
                border: 'none',
                background: projecting
                  ? 'rgba(0,240,255,0.2)'
                  : 'linear-gradient(135deg, #00f0ff 0%, #00b8ff 50%, #b300ff 100%)',
            ...
            {projected && (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                  <span style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.5)' }}>Resultado de Proyección — SE 38</span>
                  <span
                    style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem' }}>
                  <div>
                    <div style={{ fontSize: '1.5rem', fontWeight: 800, color: riskColor }}>{estimatedCases}</div>
                    <div style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.4)' }}>Casos estimados</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '1.5rem', fontWeight: 800, color: '#00f0ff' }}>87%</div>
                    <div style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.4)' }}>Confianza modelo</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '1.5rem', fontWeight: 800, color: '#b300ff' }}>3</div>
