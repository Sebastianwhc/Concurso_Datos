  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: '1000px', width: '100%', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <p
            ...
            style={{
              ...
              maxWidth: '600px', margin: '0 auto', lineHeight: 1.7, opacity: 0,
            }}
          >
        ...
        {/* Chart container */}
        <div
          className="solution-text chart-panel"
          style={{
            background: 'rgba(16, 22, 35, 0.5)', backdropFilter: 'blur(20px)',
            WebkitBackdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.05)',
            borderRadius: '24px', padding: '2.5rem 2rem',
            display: 'flex', flexDirection: 'column', alignItems: 'center', opacity: 0,
          }}
        >
          {/* Legend */}
          <div className="chart-legend" style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem', flexWrap: 'wrap', justifyContent: 'center' }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <span style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.6)' }}>{item.label}</span>
              </div>
            ))}
          </div>

          {/* Chart — scrollable on mobile */}
          <div className="solution-chart-container" style={{ width: '100%', overflowX: 'auto', WebkitOverflowScrolling: 'touch' }}>
            <svg viewBox={`0 0 ${w} ${h}`} style={{ overflow: 'visible', minWidth: '320px', width: '100%' }}>
              <defs>
              ...
              <text x={padL - 38} y={padT + chartH / 2} textAnchor="middle" fill="rgba(255,255,255,0.25)" fontSize="9" transform={`rotate(-90, ${padL - 38}, ${padT + chartH / 2})`}>
                Casos
              </text>
              <text x={padL + chartW / 2} y={h} textAnchor="middle" fill="rgba(255,255,255,0.25)" fontSize="9">
          ...
          <p
            style={{
              ...
              fontWeight: 700, color: '#fff', textAlign: 'center', lineHeight: 1.5,
            }}
          >
