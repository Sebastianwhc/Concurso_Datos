...
const Situacion2026: React.FC = () => {
  ...
  const data = useMemo(() => {
    ...
    const option: EChartsOption = {
      ...
      legend: { top: 0, right: 0, textStyle: { color: 'rgba(255,255,255,0.6)', fontSize: 11 },
        itemWidth: 14, itemHeight: 8 },
      grid: { left: 8, right: 12, top: 28, bottom: 6, containLabel: true },
      xAxis: { type: 'category', name: 'Sem. epi.', nameTextStyle: { color: 'rgba(255,255,255,0.4)' },
        data: Array.from({ length: 53 }, (_, i) => i + 1),
        axisLabel: { color: 'rgba(255,255,255,0.4)', fontSize: 10, interval: 4 },
        axisLine: { lineStyle: { color: 'rgba(255,255,255,0.12)' } } },
      yAxis: { type: 'value', name: 'casos/sem', nameTextStyle: { color: 'rgba(255,255,255,0.4)' },
